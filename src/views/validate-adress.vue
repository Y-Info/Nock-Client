<template>
  <div>
    <menu-connect route="/" />
    <h2>
      Vous allez rejoindre <br />
      La room :
    </h2>
    <div class="resultAdress">
      <div class="adress">
        <h3>Numéro et nom de rue</h3>
    ...
    <div class="button-container">
      <router-link class="buttonClick buttonAfter" to="/maps"
        >Retour</router-link
      >
      <router-link class="buttonClick buttonBefore" to="/connect"
        >Confirmer</router-link
      >
    </div>
  </div>
</template>
